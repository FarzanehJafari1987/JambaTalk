...
def main():
    ...
    parser.add_argument("--verts_path", type=str, default="vocaset/trainingdata/data_verts.npy")
    ...
    parser.add_argument("--raw_audio_path", type=str, default='vocaset/trainingdata/raw_audio_fixed.pkl')
    parser.add_argument("--wav_path", type=str, default='vocaset/wav')
    parser.add_argument("--data2array_verts_path", type=str, default='vocaset/trainingdata/subj_seq_to_idx.pkl')
